        ...
        @forelse($reservations as $res)
            <div class="card" id="res-{{ $res->reservation_id }}">
                ...
                <div class="card-right">
                    ...
                    <div class="actions">
                        {{-- Universal View --}}
                        <button class="btn-view" onclick="handleView({
                            status: '{{ ucfirst($res->status) }}',
                            facility: '{{ $res->room->room_number ?? 'Unknown' }}',
                            date: '{{ \Carbon\Carbon::parse($res->start_time)->format('F j, Y') }}',
                        ...
                        {{-- Universal Cancel --}}
                        <button class="btn-cancel" onclick="handleCancel('{{ route('reservation.destroy', $res->reservation_id) }}')">
